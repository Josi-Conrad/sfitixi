...
class PassengerAbsentDataGridController extends DataGridAbstractController{
    ...
    public function createCustomControlTile()
    {
        ...
        $selectionButton->add(new TextLinkListTile($this->generateUrl('tixiapi_passenger_absent_edit',array('passengerId'=>$this->routeProperties['passengerId'],'absentId'=>DataGridHandler::$dataGirdReplaceIdentifier)),'button.edit',true));
