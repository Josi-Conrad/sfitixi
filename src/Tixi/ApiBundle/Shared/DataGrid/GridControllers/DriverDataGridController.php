...
class DriverDataGridController extends DataGridAbstractController {
    ...
    public function createCustomControlTile() {
        ...
        $selectionButton->add(new TextLinkListTile($this->generateUrl('tixiapi_driver_get', array('driverId' => DataGridHandler::$dataGirdReplaceIdentifier)), 'button.show', true));
        $selectionButton->add(new TextLinkListTile($this->generateUrl('tixiapi_driver_edit', array('driverId' => DataGridHandler::$dataGirdReplaceIdentifier)), 'button.edit', true));
        ...
        $selectionButton->add(new TextLinkListTile($this->generateUrl('tixiapi_driver_repeatedassertionplan_new', array('driverId' => DataGridHandler::$dataGirdReplaceIdentifier)), 'repeateddrivingmission.button.new', true));
        $selectionButton->add(new SelectionButtonDividerTile());
        $selectionButton->add(new TextLinkListDeleteTile($this->generateUrl('tixiapi_driver_delete', array('driverId' => DataGridHandler::$dataGirdReplaceIdentifier)), 'button.delete', true));
